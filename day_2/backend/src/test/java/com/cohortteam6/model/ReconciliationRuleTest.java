...
class ReconciliationRuleTest {
    ...
    void matches(ReconciliationRule testingRule, BigDecimal internalPrc, BigDecimal externalPrc,
                 BigDecimal internalQty, BigDecimal externalQty, boolean isMatchExpected) {
                 
        assertThat(testingRule.matches(internalPrc, internalQty, externalPrc, externalQty))
